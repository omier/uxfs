...
int
ux_get_block(struct inode *inode, sector_t block,
...
int
ux_writepage(struct page *page, struct writeback_control *wbc)
{
...
int
ux_write_begin(struct file *file, struct address_space *mapping,
...
sector_t
ux_bmap(struct address_space *mapping, sector_t block)
{
