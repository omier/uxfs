...
typedef struct posix_acl_entry ux_acl_entry;

#define ux_acl_size(count) sizeof(struct posix_acl) + count * sizeof(ux_acl_entry)
#define ux_acl_count(size) (size - sizeof(struct posix_acl)) / sizeof(ux_acl_entry)
